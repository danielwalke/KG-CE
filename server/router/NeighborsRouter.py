...
async def get_neighbors(in_neighbor_retrieval: InNeighborRetrieval):
    retriever = Retriever()
    neighbors = retriever.retrieve_all_neighboring_nodes(in_neighbor_retrieval.node_id, limit=in_neighbor_retrieval.max_neighbors, skip=in_neighbor_retrieval.skip, topic_prompt=in_neighbor_retrieval.topic_prompt)
